...
import { ToolResult, ToolHandler, createTextResult, createErrorResult } from "../types.js";
import { getTagManagerClient, withAuthRetry, clearCachedClient, log } from "../../utils/index.js";
...
const handleGtmRemoveSession = async (
...
export const handleToolCall = async (
  ...
  try {
    ...
    if (name === "gtm_remove_session") {
      return await handleGtmRemoveSession(null as unknown as tagmanager_v2.Tagmanager, args);
    }
...
export {
  ...
  handleGtmVariable,
  handleGtmVersion,
  handleGtmBuiltInVariable,
  handleGtmClient,
  handleGtmDestination,
  handleGtmEnvironment,
  handleGtmFolder,
  handleGtmGtagConfig,
  handleGtmTemplate,
  handleGtmTransformation,
  handleGtmUserPermission,
  handleGtmVersionHeader,
  handleGtmZone,
  handleGtmExportFull,
  handleGtmCache,
  handleGtmWorkflow,
